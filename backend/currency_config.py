...
CURRENCY_CONFIG = {
    ...
    'EUR': {'name': 'Euro', 'symbol': '€', 'locale': 'fr-FR', 'decimalDigits': 0, 'rateToUSD': 0.86655},
    'GBP': {'name': 'British Pound', 'symbol': '£', 'locale': 'en-GB', 'decimalDigits': 0, 'rateToUSD': 0.74075},
    ...
    'MAD': {'name': 'Moroccan Dirham', 'symbol': 'MAD', 'locale': 'fr-MA', 'decimalDigits': 0, 'rateToUSD': 9.3130},
    'DZD': {'name': 'Algerian Dinar', 'symbol': 'دج', 'locale': 'ar-DZ', 'decimalDigits': 0, 'rateToUSD': 132.9550},
    ...
    'JPY': {'name': 'Japanese Yen', 'symbol': '¥', 'locale': 'ja-JP', 'decimalDigits': 0, 'rateToUSD': 158.77},
    ...
    'KRW': {'name': 'South Korean Won', 'symbol': '₩', 'locale': 'ko-KR', 'decimalDigits': 0, 'rateToUSD': 1416.0},
